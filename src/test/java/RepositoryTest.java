...
//    no longer needed as next test supersedes
//    @Test
...
//    }
    ...
    public void canGetAllCommitsForType(){
        ...
        ArrayList<Commit> expectedCommits = new ArrayList<Commit>();
        expectedCommits.add(commit);
        expectedCommits.add(commit2);

        assertEquals(expectedCommits, repo.getAllCommitsByType(CommitType.FEATURE));
